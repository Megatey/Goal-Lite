    ...
    <div>
      {latestMatches && <div className="latest-matches-container">
        ...
        <div className="matches-list-container">
          {
            latestMatches?.map(match => (<div key={match.indexOf} className='match-container'>
      ...
      {premierLeague && <div className="EPL-matches-container">
        ...
        <div className="matches-list-container">
          {
            premierLeague?.map(match => (<div key={match.indexOf} className='match-container'>
              <div className="image-container">
                <img src={match.thumbnail} alt="thumbnail" className='thumbnail' />
              </div>
              <p className="title">{match.title}</p>
      ...
      {laliga && <div className="matches-container">
        ...
        <div className="matches-list-container">
          {
            laliga?.map(match => (<div key={match.indexOf} className='match-container'>
              <div className="image-container">
                <img src={match.thumbnail} alt="thumbnail" className='thumbnail' />
              </div>
              <p className="title">{match.title}</p>
      ...
      {seriaA && <div className="matches-container">
        ...
        <div className="matches-list-container">
          {
            seriaA?.map(match => (<div key={match.indexOf} className='match-container'>
              <div className="image-container">
                <img src={match.thumbnail} alt="thumbnail" className='thumbnail' />
              </div>
              <p className="title">{match.title}</p>
      ...
      {ligue1 && <div className="matches-container">
        ...
        <div className="matches-list-container">
          {
            ligue1?.map(match => (<div key={match.indexOf} className='match-container'>
              <div className="image-container">
                <img src={match.thumbnail} alt="thumbnail" className='thumbnail' />
              </div>
              <p className="title">{match.title}</p>
      ...
      {bundesliga && <div className="matches-container">
        ...
        <div className="matches-list-container">
          {
            bundesliga?.map(match => (<div key={match.indexOf} className='match-container'>
              <div className="image-container">
                <img src={match.thumbnail} alt="thumbnail" className='thumbnail' />
              </div>
              <p className="title">{match.title}</p>
